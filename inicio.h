...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(97, 110);
			...
			this->label2->Location = System::Drawing::Point(502, 4);
			...
			this->label3->Location = System::Drawing::Point(171, 4);
...
#pragma endregion
	...
	private: System::Void timer1_Tick_1(System::Object^ sender, System::EventArgs^ e) {
		if (timer1->Interval == 1200) {
			...
			proyfereteria::login^ m = gcnew proyfereteria::login();
			this->Visible = false;
			m->ShowDialog();
			this->Visible = true;
